...
public final class HashStructTest_hash {
    ...
    public Collection<? extends Result> hash_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            HashStructTest_1_jmh l_hashstructtest0_G = _jmh_tryInit_f_hashstructtest0_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_hashstructtest0_G.hash());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            hash_thrpt_jmhLoop(control, res, l_hashstructtest0_G, l_blackhole1_0);
    ...
    public void hash_thrpt_jmhLoop(InfraControl control, RawResults result, HashStructTest_1_jmh l_hashstructtest0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> hash_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            hash_avgt_jmhLoop(control, res, l_hashstructtest0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void hash_avgt_jmhLoop(InfraControl control, RawResults result, HashStructTest_1_jmh l_hashstructtest0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> hash_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            hash_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_hashstructtest0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_hashstructtest0_G.hash());
    ...
    public void hash_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, HashStructTest_1_jmh l_hashstructtest0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> hash_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            hash_ss_jmhStub(control, batchSize, res, l_hashstructtest0_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
    ...
    public void hash_ss_jmhStub(InfraControl control, int batchSize, RawResults result, HashStructTest_1_jmh l_hashstructtest0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile HashStructTest_1_jmh f_hashstructtest0_G;
    
    HashStructTest_1_jmh _jmh_tryInit_f_hashstructtest0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_hashstructtest0_G == null) {
                f_hashstructtest0_G = new HashStructTest_1_jmh();
            }
            if (!f_hashstructtest0_G.readyTrial) {
                Field f;
                f = com.gmail.woodyc40.commons.HashStructTest.class.getDeclaredField("hash");
                f.setAccessible(true);
                f.set(f_hashstructtest0_G, Integer.valueOf(control.getParam("hash")));
                f_hashstructtest0_G.readyTrial = true;
            }
        }
        return f_hashstructtest0_G;
    }
